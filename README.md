...
- 🤖 **Gemini 驅動**：預設使用 Google 的 `gemini-flash-lite-latest` 模型，翻譯速度極快且精準。
...
### 第二步：一鍵翻譯
1. 開啟任何英文網頁（如：<a href="https://en.wikipedia.org/wiki/Main_Page" target="_blank" rel="noopener noreferrer">Wikipedia</a>）。
2. 點擊頁面右下角的藍色圓形 **「譯」** 按鈕。
